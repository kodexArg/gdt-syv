---
title: "Manual de Juego — Subordinación y Valor"
order: 0
section: index
lang: es
---

# Subordinación y Valor — Manual de Juego

1. [Introducción](01-introduccion.md) — Qué es SyV, la filosofía del juego
2. [El Campo de Batalla](02-campo-de-batalla.md) — Grilla hexagonal, terreno y elevación
3. [Escala y Distancias](02b-distancias.md) — 100 m por hex, tabla de distancias, ocupación
4. [Facciones](03-facciones.md) — Las facciones jugables y su cadena de mando
